export const STORAGE_KEYS = {
  ONBOARDING_COMPLETED: 'puol:onboarding_completed',
  ...
  LANDLORD_APPLICATION_COMPLETED: 'puol:landlord_application_completed',
  LANDLORD_PROFILE: 'puol:landlord_profile',
} as const;
