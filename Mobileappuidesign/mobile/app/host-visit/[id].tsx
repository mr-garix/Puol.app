...
export default function HostVisitDetailsScreen() {
  ...
  useEffect(() => {
    ...
    fetchVisit(id)
      .catch((error) => {
        console.error('[HostVisitDetailsScreen] Unable to fetch visit', error);
      })
    ...
    <SafeAreaView style={[styles.safeArea, { paddingTop: insets.top + 6 }]}>
      ...
      {isBusy ? (
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity style={styles.visitorRow} activeOpacity={0.85} onPress={handleOpenGuestProfile}>
              ...
              />
              <View style={{ flex: 1 }}>
                <Text style={styles.visitorName}>{guestDisplayName}</Text>
        ...
        <View style={styles.loadingContainer}>
          ...
          <TouchableOpacity style={styles.retryButton} onPress={() => router.replace('/host-visits' as never)} activeOpacity={0.8}>
