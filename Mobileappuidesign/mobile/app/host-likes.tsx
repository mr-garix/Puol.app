      ...
      <View style={[styles.headerWrapper, { paddingTop: topPadding }]}> 
        <View style={styles.headerRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.headerSubtitle}>Suivez l’engagement sur vos annonces</Text>
          </View>
          <View style={{ width: 44 }} />
        </View>
      </View>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.summaryCard}>
          <View>
            ...
            <Text style={styles.summaryValue}>0 like</Text>
          </View>
          <View style={styles.divider} />
          <Text style={styles.summaryHint}>Les likes apparaîtront ici dès que vos annonces seront publiées.</Text>
        </View>
        ...
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptySubtitle}>
            Dès que des locataires aimeront vos annonces ou vos visites vidéo, leurs profils seront listés ici avec un lien
            direct vers leur fiche.
          </Text>
        ...
        <View style={styles.placeholderList}>
          <Text style={styles.placeholderTitle}>Historique des likes</Text>
          <Text style={styles.placeholderSubtitle}>Vos prochains likes s’afficheront automatiquement ci-dessous.</Text>
          {[1, 2].map((item) => (
            <View key={item} style={styles.placeholderRow}>
              <View style={styles.placeholderAvatar} />
              <View style={{ flex: 1, gap: 8 }}>
                <View style={styles.placeholderLineFull} />
                <View style={[styles.placeholderLineFull, { width: '40%' }]} />
              </View>
            </View>
          ))}
        </View>
